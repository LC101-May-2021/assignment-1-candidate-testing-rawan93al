...
function gradeQuiz(candidateAnswers) {
  ...
  grade=numberofcorrectquestions/5*100;
  console.log(">>> Overall Grade: "+ grade +"% ("+numberofcorrectquestions + " of 5 responses correct) <<<");
  let Status=" ";

  if (grade >=80)console.log(">>> Status: PASSED <<<");
